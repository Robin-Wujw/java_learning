 ...
 * @Pointcut("execution(* com.robin.spring.aop.annotation.impl.CalculatorImpl.*(..))")
...
public class LoggerAspect {
    ...
    @Pointcut("execution(* com.robin.spring.aop.annotation.impl.CalculatorImpl.*(..))")
    public  void pointCut(){}
    //@Before("execution(public int com.robin.spring.aop.annotation.impl.CalculatorImpl.add(int,int))")
